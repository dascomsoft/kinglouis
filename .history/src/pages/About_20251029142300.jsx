...
const About = () => {
  ...
  return (
    <div className="pt-20 mb-7 sm:pt-24 lg:pt-28 pb-12 sm:pb-16">
      {/* Header Section */}
      <section className="relative min-h-[30vh] bg-linear-to-br from-slate-800 via-slate-400 to-blue-950 text-white py-12 sm:py-16 lg:py-20">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
            {/* Vision */}
            <div 
              className="group bg-linear-to-br from-blue-50 to-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 lg:hover:-translate-y-2 border-l-4 border-blue-600"
              data-aos="fade-right"
            >
              <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left mb-4 sm:mb-6">
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-linear-to-r from-blue-600 to-blue-700 flex items-center justify-center mb-4 sm:mb-0 sm:mr-4 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
