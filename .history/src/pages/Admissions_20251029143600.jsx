    ...
    <div className="pt-20 sm:pt-24 lg:pt-18 pb-12 sm:pb-16">
      ...
      <section className="bg-gradient-to-br from-gray-800 via-gray-900 to-gray-950 text-white py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl text-am sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6" data-aos="fade-up">
            Admissions
          </h1>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div 
            className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 border-l-4 border-blue-600 shadow-lg"
            data-aos="fade-up"
          >
