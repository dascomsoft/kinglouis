...
const Home = () => {
  ...
  return (
    <div className="pt-24">
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center bg-linear-to-br from-primary-blue via-primary-dark to-primary-blue overflow-hidden">
      ...
      {/* Quote Section */}
      <section className="bg-linear-to-r from-primary-gold to-secondary-light py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group text-center p-8 rounded-2xl bg-linear-to-br from-gray-50 to-white border border-gray-100 hover:border-transparent shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2"
                data-aos="fade-up"
                data-aos-delay={index * 100}
              >
                <div className={`w-20 h-20 rounded-2xl bg-linear-to-r ${feature.color} flex items-center justify-center text-white mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                  {feature.icon}
                </div>
      ...
      {/* Stats Section */}
      <section className="py-20 bg-linear-to-br from-primary-blue to-primary-dark text-white">
        <div className="container mx-auto px-4">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-linear-to-r from-primary-blue to-primary-dark relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
