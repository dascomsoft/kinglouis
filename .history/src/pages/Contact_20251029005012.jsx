...
const Contact = () => {
  ...
  return (
    <div className="pt-28 pb-16">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${info.color} flex items-center justify-center text-white mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}>
                  {info.icon}
                </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div 
                ...
                data-aos-delay="200"
              >
                <div className="bg-gradient-to-r from-primary-blue to-primary-dark p-6 text-white">
      ...
      <section className="py-16 bg-gradient-to-br from-primary-gold to-secondary-light">
