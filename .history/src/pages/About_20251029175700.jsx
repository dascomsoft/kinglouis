...
const About = () => {
  ...
  return (
    <div className="pt-20 mt-7 sm:pt-24 lg:pt-18 pb-12 sm:pb-16">
      {/* Header Section */}
      <section className="relative min-h-[60vh] flex items-center justify-center bg-linear-to-br from-blue-800 via-slate-900 to-blue-900 text-white py-12 sm:py-16 lg:py-20">
