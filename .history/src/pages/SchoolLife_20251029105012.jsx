    ...
    <div className="pt-28 pb-16">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div 
            className="bg-linear-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg border-l-4 border-primary-blue"
            data-aos="fade-up"
          >
            ...
            {rules.map((rule, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className={`w-12 h-12 rounded-2xl bg-linear-to-r ${getSeverityColor(rule.severity)} flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300 flex-shrink-0`}>
                    {rule.icon}
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div data-aos="fade-right">
              <div className="bg-linear-to-br from-primary-blue to-primary-dark rounded-2xl p-8 text-white h-full">
            ...
            <div data-aos="fade-left">
              <div className="bg-linear-to-br from-purple-500 to-purple-600 rounded-2xl p-8 text-white h-full">
