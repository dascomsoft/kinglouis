        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {programs.map((program, index) => (
              <div
                key={index}
                className="group bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-l-4 border-primary-blue"
                data-aos="fade-up"
                data-aos-delay={index * 100}
              >
                <div className={`w-20 h-20 rounded-2xl bg-gradient-to-r ${program.color} flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  {program.icon}
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-primary-blue rounded-2xl flex items-center justify-center flex-shrink-0">
