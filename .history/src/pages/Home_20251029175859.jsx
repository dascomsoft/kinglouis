...
const Home = () => {
  ...
  return (
    <div className="pt-20">
      {/* Hero Section */}
      <section className="relative relative min-h-[50vh] flex items-center justify-centerrelative min-h-[50vh] flex items-center justify-center mt-0 overflow-hidden">
        {/* Background Image */}
        <div
