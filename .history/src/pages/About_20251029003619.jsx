...
import { FaEye, FaTarget, FaGraduationCap, FaUsers, FaPrayingHands, FaHistory, FaMapMarkerAlt, FaAward } from 'react-icons/fa'
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
