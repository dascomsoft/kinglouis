          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
            ...
            >
              <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left mb-4 sm:mb-6">
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg--to-r from-blue-600 to-blue-700 flex items-center justify-center mb-4 sm:mb-0 sm:mr-4 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
