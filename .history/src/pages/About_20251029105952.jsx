...
const About = () => {
  ...
  return (
    <div className="pt-28 pb-16">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Vision */}
            <div 
              className="group bg-linear-to-br from-blue-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-l-4 border-blue-500"
              data-aos="fade-right"
            >
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-2xl bg-linear-to-r from-blue-500 to-blue-600 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
            ...
            {/* Mission */}
            <div 
              className="group bg-linear-to-br from-yellow-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-l-4 border-yellow-500"
              data-aos="fade-left"
            >
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-2xl bg-linear-to-r from-yellow-500 to-yellow-600 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className={`w-20 h-20 rounded-2xl bg-linear-to-r ${value.color} flex items-center justify-center text-white mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                  {value.icon}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-linear-to-b from-primary-blue to-primary-gold h-full"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
              ...
              <div className="flex items-start space-x-4 mb-6">
                <FaMapMarkerAlt className="text-primary-gold text-2xl mt-1 shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-4">
                <FaHistory className="text-primary-blue text-2xl mt-1 shrink-0" />
                <div>
            ...
            <div 
              ...
              data-aos="fade-left"
            >
              <div className="h-80 bg-linear-to-br from-primary-blue to-primary-dark flex items-center justify-center">
      ...
      {/* Catholic Identity */}
      <section className="py-20 bg-linear-to-r from-primary-blue to-primary-dark text-white">
        <div className="container mx-auto px-4 text-center">
