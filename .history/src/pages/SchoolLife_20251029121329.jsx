...
const SchoolLife = () => {
  ...
  return (
    <div className="pt-20">
      {/* Header Section */}
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-gray-800 via-gray-900 to-gray-950 overflow-hidden">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div 
            className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg border-l-4 border-amber-500"
            data-aos="fade-up"
          >
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 flex items-center justify-center text-white">
            ...
            {rules.map((rule, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${getSeverityColor(rule.severity)} flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300 shrink-0`}>
                    {rule.icon}
                  </div>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <span className={`inline-block mt-1 px-2 py-1 rounded-full text-xs font-semibold ${
                          rule.severity === 'very-high' ? 'bg-red-100 text-red-800' :
