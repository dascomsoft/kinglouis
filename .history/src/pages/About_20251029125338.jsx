...
const About = () => {
  ...
  return (
    <div className="pt-20 relative min-h-[60vh]  sm:pt-24 lg:pt-28 pb-12 sm:pb-16">
      {/* Header Section */}
      <section className="bg-linear-to-br from-blue-800 via-blue-900 to-blue-950 text-white py-12 sm:py-16 lg:py-20">
