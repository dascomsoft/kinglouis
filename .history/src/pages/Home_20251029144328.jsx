...
const Home = () => {
  ...
  return (
    <div className="pt-20">
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center mt-0 bg-linear-to-br from-gray-800 via-gray-900 to-gray-950 overflow-hidden">
      ...
      {/* Quote Section */}
      <section className="bg-gradient-to-r from-amber-500 to-amber-400 py-12 sm:py-16 relative overflow-hidden">
