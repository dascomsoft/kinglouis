            ...
            {rules.map((rule, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className={`w-12 h-12 rounded-2xl bg-linear-to-r ${getSeverityColor(rule.severity)} flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300 shrink-0`}>
                    {rule.icon}
                  </div>
