    ...
    <div className="pt-28 pb-16">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div 
            className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border-l-4 border-primary-blue shadow-lg"
            data-aos="fade-up"
          >
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              {activeTab === 'fees' && (
                <div data-aos="fade-right">
                  <div className="bg-gradient-to-r from-primary-blue to-primary-dark p-8 text-white">
      ...
      {/* Final Note */}
      <section className="py-16 bg-gradient-to-r from-primary-gold to-secondary-light">
