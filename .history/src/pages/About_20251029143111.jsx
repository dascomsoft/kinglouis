...
const About = () => {
  ...
  return (
    <div className="pt-20 mt-0 sm:pt-24 lg:pt-48 pb-12 sm:pb-16">
      {/* Header Section */}
      <section className="bg-linear-to-br from-slate-800 via-blue-900 to-blue-950 text-white py-12 sm:py-16 lg:py-20">
