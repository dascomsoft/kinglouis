        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start space-x-3">
                <FaMapMarkerAlt className="text-amber-400 mt-1 flex-shrink-0 text-sm sm:text-base" />
                <div>
              ...
              <div className="flex items-start space-x-3">
                <FaPhone className="text-amber-400 flex-shrink-0 text-sm sm:text-base" />
                <div>
